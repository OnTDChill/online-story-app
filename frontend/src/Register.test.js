...
import { Box, Typography, Card, CardContent, CardMedia, Button, Pagination, Select, MenuItem, FormControl, InputLabel, TextField, Collapse, Snackbar, Alert, Skeleton } from '@mui/material';
      ...
      <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 2 }}>
        {loading ? (
          Array.from(new Array(6)).map((_, index) => (
            <Card key={index} sx={{ width: 300, backgroundColor: '#424242' }}>

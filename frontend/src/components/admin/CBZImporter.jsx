    ...
    for (const file of selectedFiles) {
      try {
        ...
        if (imageFiles.length === 0) {
          throw new Error('Không tìm thấy hình ảnh trong file CBZ');
        }
        ...
        const storyInfo = {
          title: fileName,
          author: 'Unknown',
          description: `Truyện được import từ file CBZ: ${fileName}`,
          genre: 'Manga',
          status: 'ongoing',
          type: 'normal',
          chapters: [{
        ...
        // Trong môi trường thực tế, bạn sẽ tải từng hình ảnh lên server
        ...
        setProgress(prev => ({
          ...
          [file.name]: {
            ...prev[file.name],
            message: 'Đang tạo truyện...',
            progress: 80
          }
        }));
        
        // Giả lập tạo truyện trên server
        ...
        toast.success(`Đã import thành công: ${fileName}`);
